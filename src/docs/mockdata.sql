...
-- ============================================================
--  TBL_USR_FLWR — 팔로우 관계 더미 데이터
--  USER 1 중심: 팔로워 많음 + 팔로잉 다수
-- ============================================================
USE KNOWRA_USER;

INSERT INTO TBL_USR_FLWR (FLWR_USER_SN, FLWNG_USER_SN, ACTVTN_YN, CREATR_SN, FRST_CRT_DT) VALUES
-- ── 유저 1을 팔로우하는 사람들 (팔로워 20명) ─────────────────────
(2,  1, 'Y', 2,  '2026-01-05 09:10:00'),
(3,  1, 'Y', 3,  '2026-01-06 11:20:00'),
(4,  1, 'Y', 4,  '2026-01-07 13:30:00'),
(5,  1, 'Y', 5,  '2026-01-08 15:00:00'),
(6,  1, 'Y', 6,  '2026-01-10 08:45:00'),
(7,  1, 'Y', 7,  '2026-01-12 10:00:00'),
(8,  1, 'Y', 8,  '2026-01-14 14:20:00'),
(9,  1, 'Y', 9,  '2026-01-15 09:30:00'),
(10, 1, 'Y', 10, '2026-01-17 16:10:00'),
(11, 1, 'Y', 11, '2026-01-18 11:00:00'),
(12, 1, 'Y', 12, '2026-01-20 08:00:00'),
(13, 1, 'Y', 13, '2026-01-22 13:50:00'),
(14, 1, 'Y', 14, '2026-01-24 17:30:00'),
(15, 1, 'Y', 15, '2026-01-25 10:10:00'),
(16, 1, 'Y', 16, '2026-01-27 12:00:00'),
(17, 1, 'Y', 17, '2026-01-28 09:00:00'),
(18, 1, 'Y', 18, '2026-02-01 14:00:00'),
(19, 1, 'Y', 19, '2026-02-03 11:30:00'),
(20, 1, 'Y', 20, '2026-02-05 08:20:00'),
(21, 1, 'Y', 21, '2026-02-07 15:40:00'),

-- ── 유저 1이 팔로우하는 사람들 (팔로잉 12명) ─────────────────────
(1, 2,  'Y', 1, '2026-01-06 10:00:00'),
(1, 3,  'Y', 1, '2026-01-07 12:00:00'),
(1, 4,  'Y', 1, '2026-01-09 09:00:00'),
(1, 5,  'Y', 1, '2026-01-10 10:30:00'),
(1, 6,  'Y', 1, '2026-01-11 11:00:00'),
(1, 8,  'Y', 1, '2026-01-15 13:00:00'),
(1, 10, 'Y', 1, '2026-01-18 09:30:00'),
(1, 12, 'Y', 1, '2026-01-21 10:00:00'),
(1, 15, 'Y', 1, '2026-01-26 14:00:00'),
(1, 18, 'Y', 1, '2026-02-02 09:00:00'),
(1, 22, 'Y', 1, '2026-02-10 11:00:00'),
(1, 25, 'Y', 1, '2026-02-15 16:00:00'),

-- ── 기타 유저 간 팔로우 관계 ─────────────────────────────────────
(2,  3,  'Y', 2,  '2026-01-10 09:00:00'),
(3,  2,  'Y', 3,  '2026-01-11 10:00:00'),
(4,  5,  'Y', 4,  '2026-01-12 11:00:00'),
(5,  4,  'Y', 5,  '2026-01-13 12:00:00'),
(6,  7,  'Y', 6,  '2026-01-14 13:00:00'),
(7,  6,  'Y', 7,  '2026-01-15 14:00:00'),
(8,  9,  'Y', 8,  '2026-01-16 09:00:00'),
(9,  10, 'Y', 9,  '2026-01-17 10:00:00'),
(10, 11, 'Y', 10, '2026-01-18 11:00:00'),
(11, 12, 'Y', 11, '2026-01-19 12:00:00'),
(12, 13, 'Y', 12, '2026-01-20 13:00:00'),
(13, 14, 'Y', 13, '2026-01-21 09:00:00'),
(14, 15, 'Y', 14, '2026-01-22 10:00:00'),
(15, 16, 'Y', 15, '2026-01-23 11:00:00'),
(16, 17, 'Y', 16, '2026-01-24 12:00:00'),
(17, 18, 'Y', 17, '2026-01-25 09:00:00'),
(18, 19, 'Y', 18, '2026-01-26 10:00:00'),
(19, 20, 'Y', 19, '2026-01-27 11:00:00'),
(20, 21, 'Y', 20, '2026-01-28 12:00:00'),
(21, 22, 'Y', 21, '2026-01-29 09:00:00'),
(22, 23, 'Y', 22, '2026-01-30 10:00:00'),
(23, 24, 'Y', 23, '2026-01-31 11:00:00'),
(24, 25, 'Y', 24, '2026-02-01 12:00:00'),
(25, 26, 'Y', 25, '2026-02-02 09:00:00'),
(26, 27, 'Y', 26, '2026-02-03 10:00:00'),
(27, 28, 'Y', 27, '2026-02-04 11:00:00'),
(28, 29, 'Y', 28, '2026-02-05 12:00:00'),
(29, 30, 'Y', 29, '2026-02-06 09:00:00'),
(30, 2,  'Y', 30, '2026-02-07 10:00:00'),
(2,  10, 'Y', 2,  '2026-02-08 11:00:00'),
(5,  15, 'Y', 5,  '2026-02-09 12:00:00'),
(8,  20, 'Y', 8,  '2026-02-10 09:00:00'),
(11, 25, 'Y', 11, '2026-02-11 10:00:00'),
(14, 30, 'Y', 14, '2026-02-12 11:00:00');
